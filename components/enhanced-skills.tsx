...
export function EnhancedSkills() {
  ...
  const skillCategories = [
    {
      ...
      skills: ["UI/UX Design", "Figma", "Adobe Photoshop", "Adobe Illustrator", "Prototyping", "Canva", "Wireframing"],
    ...
    },
    {
      ...
      skills: ["C", "JavaScript", "Python", "C++", "Java", "MySQL", "Git"],
  ...
  return (
    <section id="skills" className="py-32 px-4 sm:px-6 lg:px-8 bg-[#0a0118]/50 relative overflow-hidden">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {skillCategories.map((category, index) => (
            ...
            >
              <Card
                className={`glass border-2 ${category.borderColor} hover:border-opacity-60 transition-all duration-500 relative overflow-hidden group ${
